...
{
    //public class FranchiseUser : IdentityUser<int>, IHasCreationTime, IHasDeletionTime, ISoftDelete, IHasModificationTime
    public class FranchiseUser : FullAuditedEntity
    {
